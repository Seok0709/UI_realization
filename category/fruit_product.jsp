...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
   ...
   <img src="../assets/images/pDetail/back2.png" style="width:100%;">
         <div class="row">
      ...
      <div class="container">
         <div class="row text-center">
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_ap.jsp"><img src="../assets/images/st3.png" alt="Work"></a>
                  </div>
                  <div class="desc">
            ...
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_ban.jsp"><img src="../assets/images/pban1.png" alt="Work" href="../detail/detail_ban.jsp"></a>
                  </div>
                  <div class="desc">
                     <h3><a style="font-family : sans-serif;" href="detail_ban.jsp">[제철 과일]바나나</a></h3>
            ...
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_kiwi.jsp"><img src="../assets/images/kiwi.png" alt="Work"></a>
                  </div>
                  <div class="desc">
